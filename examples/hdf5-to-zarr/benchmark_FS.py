...
def main():
    ...
    shutil.rmtree("./C07-FS.zarr", ignore_errors=True)
    ...
    h5_src = CVSourceFS(
        "/tungstenfs/scratch/gscicomp_share/gmicro/test-data-with-logs/jetraw/C07-data/",
        [
    ...
    group = zarr.group(parse_url("./C07-FS.zarr", mode="w").store, overwrite=True)
    ...
    print(f"Convert from File-System source took {end - start}.")
    print("Done.")
    client.shutdown()
